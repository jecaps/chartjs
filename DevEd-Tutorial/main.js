...
const data = {
  ...
  datasets: [
    ...
    {
      label: legend(dataObj)[2],
      data: hoursWorked(dataObj[2]),
      borderColor: "rgba(244, 172, 69, 0.7)",
      backgroundColor: "rgba(244, 172, 69, 0.2)",
      // fill: "-1",
      // backgroundColor: gradient,
      borderWidth: 2,
      pointBackgroundColor: "rgb(244, 172, 69)",
      radius: 3,
      hitRadius: 30,
      hoverRadius: 8,
      tension: 0.4,
...
const config = {
  ...
  options: {
    plugins: {
      ...
      tooltip: {
        backgroundColor: "rgba(128, 141, 142, 0.9)",
        titleFont: {
          weight: "normal",
        },
        bodyFont: {
